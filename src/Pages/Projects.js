...
import italiaPic from "../Images/italiaPic.png"
import calculatorPic from "../Images/calculatorPic.png"
import quoteMachinePic from "../Images/quoteMachinePic.png"
import slotMachinePic from "../Images/slotMachinePic.png"
...
const tiles = projectItems.map((item) => (
  <div className={classes.tile} key={item.title}>
    ...
    <div className={classes.tileImgFormat}>
      <img src={item.img} alt={item.title} className={classes.tileImg} />
